    ...
    func requestUserLocationAuthorization() {
        if CLLocationManager.locationServicesEnabled() {
            ...
            case .authorizedAlways, .authorizedWhenInUse:
                mapView.addSubview(btUserLocation) //Mostrar o botao de localizacao no mapa
            case .denied:
                showMessage(type: .authorizationWarning) //Mostrar um alerta
            case .notDetermined:
                locationManager.requestWhenInUseAuthorization() //usuario nunca viu a autorizacao
            case .restricted:
            break //app nao aceita. controle parental etc...
            }
        } else {
            //Não dá
        }
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        search.start { response, error in
            if error == nil {
                ...
                self.poi.removeAll()  //*** poi (points of interest) *** - pontos de interesse
